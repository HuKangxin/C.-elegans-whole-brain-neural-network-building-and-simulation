...
#define nrn_init _nrn_init__OSM9_trpv
#define _nrn_initial _nrn_initial__OSM9_trpv
#define nrn_cur _nrn_cur__OSM9_trpv
#define _nrn_current _nrn_current__OSM9_trpv
#define nrn_jacob _nrn_jacob__OSM9_trpv
#define nrn_state _nrn_state__OSM9_trpv
#define _net_receive _net_receive__OSM9_trpv 
#define rates rates__OSM9_trpv 
#define states states__OSM9_trpv 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_OSM9_trpv", _hoc_setdata,
 "rates_OSM9_trpv", _hoc_rates,
 0, 0
};
...
#define _gth 0
#define h_d h_d_OSM9_trpv
 double h_d = 1.6;
#define h_c h_c_OSM9_trpv
 double h_c = 9.8;
#define h_b h_b_OSM9_trpv
 double h_b = -75.7;
#define h_a h_a_OSM9_trpv
 double h_a = 23.4;
#define h_V h_V_OSM9_trpv
 double h_V = -73;
#define htau_OSM9_trpv _thread1data[0]
#define htau _thread[_gth]._pval[0]
#define hinf_OSM9_trpv _thread1data[1]
#define hinf _thread[_gth]._pval[1]
#define k_i k_i_OSM9_trpv
 double k_i = 8.1;
#define k_a k_a_OSM9_trpv
 double k_a = 2.7;
#define m_d m_d_OSM9_trpv
 double m_d = 0.4;
#define m_c m_c_OSM9_trpv
 double m_c = 21.9;
#define m_b m_b_OSM9_trpv
 double m_b = -95.5;
#define m_a m_a_OSM9_trpv
 double m_a = 20;
#define m_V m_V_OSM9_trpv
 double m_V = -60.7;
#define mtau_OSM9_trpv _thread1data[2]
#define mtau _thread[_gth]._pval[2]
#define minf_OSM9_trpv _thread1data[3]
#define minf _thread[_gth]._pval[3]
 ...
 "mtau_OSM9_trpv", "ms",
 "htau_OSM9_trpv", "ms",
 "gosm9bar_OSM9_trpv", "nS/cm2",
 "gosm9_OSM9_trpv", "nS/cm2",
 0,0
};
 ...
 "m_V_OSM9_trpv", &m_V_OSM9_trpv,
 "k_a_OSM9_trpv", &k_a_OSM9_trpv,
 "h_V_OSM9_trpv", &h_V_OSM9_trpv,
 "k_i_OSM9_trpv", &k_i_OSM9_trpv,
 "m_a_OSM9_trpv", &m_a_OSM9_trpv,
 "m_b_OSM9_trpv", &m_b_OSM9_trpv,
 "m_c_OSM9_trpv", &m_c_OSM9_trpv,
 "m_d_OSM9_trpv", &m_d_OSM9_trpv,
 "h_a_OSM9_trpv", &h_a_OSM9_trpv,
 "h_b_OSM9_trpv", &h_b_OSM9_trpv,
 "h_c_OSM9_trpv", &h_c_OSM9_trpv,
 "h_d_OSM9_trpv", &h_d_OSM9_trpv,
 "minf_OSM9_trpv", &minf_OSM9_trpv,
 "hinf_OSM9_trpv", &hinf_OSM9_trpv,
 "mtau_OSM9_trpv", &mtau_OSM9_trpv,
 "htau_OSM9_trpv", &htau_OSM9_trpv,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 OSM9_trpv D:/download/yanjjiusheng/hukangxin/hukangxin/mod/OSM9_trpv.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "OSM9_ca.mod Potassium ion channel of HH model in C.elegans";
...
#if NMODL_TEXT
static const char* nmodl_filename = "OSM9_trpv.mod";
static const char* nmodl_file_text = 
