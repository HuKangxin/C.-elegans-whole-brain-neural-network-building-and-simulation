...
#define nrn_init _nrn_init__SLO2_EGL19_cak
#define _nrn_initial _nrn_initial__SLO2_EGL19_cak
#define nrn_cur _nrn_cur__SLO2_EGL19_cak
#define _nrn_current _nrn_current__SLO2_EGL19_cak
#define nrn_jacob _nrn_jacob__SLO2_EGL19_cak
#define nrn_state _nrn_state__SLO2_EGL19_cak
#define _net_receive _net_receive__SLO2_EGL19_cak 
#define rates rates__SLO2_EGL19_cak 
#define states states__SLO2_EGL19_cak 
...
#define gslo2_egl19bar _p[0]
#define gslo2_egl19 _p[1]
#define m _p[2]
#define Dm _p[3]
#define ek _p[4]
#define ik _p[5]
...
#define minf_egl19	*_ppvar[3]._pval
#define _p_minf_egl19	_ppvar[3]._pval
#define mtau_egl19	*_ppvar[4]._pval
#define _p_mtau_egl19	_ppvar[4]._pval
#define m_egl19	*_ppvar[5]._pval
#define _p_m_egl19	_ppvar[5]._pval
#define h_egl19	*_ppvar[6]._pval
#define _p_h_egl19	_ppvar[6]._pval
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_SLO2_EGL19_cak", _hoc_setdata,
 "rates_SLO2_EGL19_cak", _hoc_rates,
 0, 0
};
 /* declare global and static user variables */
#define mtau mtau_SLO2_EGL19_cak
 double mtau = 0;
#define minf minf_SLO2_EGL19_cak
 double minf = 0;
 ...
 "mtau_SLO2_EGL19_cak", "ms",
 "gslo2_egl19bar_SLO2_EGL19_cak", "pS/cm2",
 "gslo2_egl19_SLO2_EGL19_cak", "pS/cm2",
 "mtau_egl19_SLO2_EGL19_cak", "ms",
 0,0
};
 ...
 "minf_SLO2_EGL19_cak", &minf_SLO2_EGL19_cak,
 "mtau_SLO2_EGL19_cak", &mtau_SLO2_EGL19_cak,
 0,0
};
...
#define _cvode_ieq _ppvar[7]._i
 ...
 "7.7.0",
"SLO2_EGL19_cak",
 "gslo2_egl19bar_SLO2_EGL19_cak",
 0,
 "gslo2_egl19_SLO2_EGL19_cak",
 0,
 "m_SLO2_EGL19_cak",
 0,
 "minf_egl19_SLO2_EGL19_cak",
 "mtau_egl19_SLO2_EGL19_cak",
 "m_egl19_SLO2_EGL19_cak",
 "h_egl19_SLO2_EGL19_cak",
 0};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 7, "cvodeieq");
 	...
 	ivoc_help("help ?1 SLO2_EGL19_cak D:/download/yanjjiusheng/hukangxin/hukangxin/mod/SLO2_EGL19_cak.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "SLO2_EGL19_cak.mod Potassium ion channel of HH model in C.elegans";
...
static int  rates (  double _lv ) {
  ...
  _lq10 = pow( 3.0 , ( ( celsius - 6.3 ) / 10.0 ) ) ;
   ...
   _lk1 = 0.027 * exp ( 0.024 * _lv ) / ( 1.0 + pow( ( 93.45 / _lCa_oBK ) , 1.84 ) ) ;
   _lk2 = 0.9 * exp ( - 0.019 * _lv ) / ( 1.0 + pow( ( 0.05 / 3294.55 ) , 0.00001 ) ) ;
   _lk3 = 0.87 * exp ( - 0.019 * _lv ) / ( 1.0 + pow( ( _lCa_oBK / 3294.55 ) , 0.00001 ) ) ;
   _lalpha = minf_egl19 / mtau_egl19 ;
   _lbeta = 1.0 / mtau_egl19 - _lalpha ;
   minf = m_egl19 * _lk1 * ( _lalpha + _lbeta + _lk2 ) / ( ( _lk1 + _lk3 ) * ( _lk2 + _lalpha ) + _lbeta * _lk2 ) ;
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 50 in file SLO2_EGL19_cak.mod:\n        SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "SLO2_EGL19_cak.mod";
static const char* nmodl_file_text = 
