...
#define nrn_init _nrn_init__KCNL_CaSK
#define _nrn_initial _nrn_initial__KCNL_CaSK
#define nrn_cur _nrn_cur__KCNL_CaSK
#define _nrn_current _nrn_current__KCNL_CaSK
#define nrn_jacob _nrn_jacob__KCNL_CaSK
#define nrn_state _nrn_state__KCNL_CaSK
#define _net_receive _net_receive__KCNL_CaSK 
#define rates rates__KCNL_CaSK 
#define states states__KCNL_CaSK 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_KCNL_CaSK", _hoc_setdata,
 "rates_KCNL_CaSK", _hoc_rates,
 0, 0
};
 ...
 "gkcnlbar_KCNL_CaSK", "nS/cm2",
 "gkcnl_KCNL_CaSK", "pS/cm2",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 KCNL_CaSK D:/download/yanjjiusheng/hukangxin/hukangxin/mod/KCNL_CaSK.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "KCNL_CaSK.mod Potassium ion channel of HH model in C.elegans";
...
#if NMODL_TEXT
static const char* nmodl_filename = "KCNL_CaSK.mod";
static const char* nmodl_file_text = 
