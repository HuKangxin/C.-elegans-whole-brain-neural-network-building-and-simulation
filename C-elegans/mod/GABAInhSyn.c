...
#define nrn_init _nrn_init__GABAInhSyn
#define _nrn_initial _nrn_initial__GABAInhSyn
#define nrn_cur _nrn_cur__GABAInhSyn
#define _nrn_current _nrn_current__GABAInhSyn
#define nrn_jacob _nrn_jacob__GABAInhSyn
#define nrn_state _nrn_state__GABAInhSyn
#define _net_receive _net_receive__GABAInhSyn 
#define state state__GABAInhSyn 
...
#define factor factor_GABAInhSyn
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 add_nrn_fornetcons(_mechtype, _fnc_index);
 	...
 	ivoc_help("help ?1 GABAInhSyn D:/download/yanjjiusheng/hukangxin/hukangxin/mod/GABAInhSyn.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Syn.mod";
...
#if NMODL_TEXT
static const char* nmodl_filename = "GABAInhSyn.mod";
static const char* nmodl_file_text = 
  "TITLE Syn.mod\n"
  "\n"
  "COMMENT\n"
