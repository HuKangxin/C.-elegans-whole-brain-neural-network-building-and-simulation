...
#define nrn_init _nrn_init__KVS1_pas
#define _nrn_initial _nrn_initial__KVS1_pas
#define nrn_cur _nrn_cur__KVS1_pas
#define _nrn_current _nrn_current__KVS1_pas
#define nrn_jacob _nrn_jacob__KVS1_pas
#define nrn_state _nrn_state__KVS1_pas
#define _net_receive _net_receive__KVS1_pas 
#define rates rates__KVS1_pas 
#define states states__KVS1_pas 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_KVS1_pas", _hoc_setdata,
 "rates_KVS1_pas", _hoc_rates,
 0, 0
};
...
#define _gth 0
#define h_d h_d_KVS1_pas
 double h_d = 5.3;
#define h_c h_c_KVS1_pas
 double h_c = 15;
#define h_b h_b_KVS1_pas
 double h_b = 50;
#define h_a h_a_KVS1_pas
 double h_a = 8.9;
#define h_V h_V_KVS1_pas
 double h_V = 17.3;
#define htau_KVS1_pas _thread1data[0]
#define htau _thread[_gth]._pval[0]
#define hinf_KVS1_pas _thread1data[1]
#define hinf _thread[_gth]._pval[1]
#define k_i k_i_KVS1_pas
 double k_i = 11.1;
#define k_a k_a_KVS1_pas
 double k_a = 25;
#define m_d m_d_KVS1_pas
 double m_d = 0.1;
#define m_c m_c_KVS1_pas
 double m_c = 20;
#define m_b m_b_KVS1_pas
 double m_b = 18.1;
#define m_a m_a_KVS1_pas
 double m_a = 3;
#define m_V m_V_KVS1_pas
 double m_V = 27.1;
#define mtau_KVS1_pas _thread1data[2]
#define mtau _thread[_gth]._pval[2]
#define minf_KVS1_pas _thread1data[3]
#define minf _thread[_gth]._pval[3]
 ...
 "mtau_KVS1_pas", "ms",
 "htau_KVS1_pas", "ms",
 "gkvs1bar_KVS1_pas", "nS/cm2",
 "gkvs1_KVS1_pas", "nS/cm2",
 0,0
};
 ...
 "m_V_KVS1_pas", &m_V_KVS1_pas,
 "k_a_KVS1_pas", &k_a_KVS1_pas,
 "h_V_KVS1_pas", &h_V_KVS1_pas,
 "k_i_KVS1_pas", &k_i_KVS1_pas,
 "m_a_KVS1_pas", &m_a_KVS1_pas,
 "m_b_KVS1_pas", &m_b_KVS1_pas,
 "m_c_KVS1_pas", &m_c_KVS1_pas,
 "m_d_KVS1_pas", &m_d_KVS1_pas,
 "h_a_KVS1_pas", &h_a_KVS1_pas,
 "h_b_KVS1_pas", &h_b_KVS1_pas,
 "h_c_KVS1_pas", &h_c_KVS1_pas,
 "h_d_KVS1_pas", &h_d_KVS1_pas,
 "minf_KVS1_pas", &minf_KVS1_pas,
 "hinf_KVS1_pas", &hinf_KVS1_pas,
 "mtau_KVS1_pas", &mtau_KVS1_pas,
 "htau_KVS1_pas", &htau_KVS1_pas,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 KVS1_pas D:/download/yanjjiusheng/hukangxin/hukangxin/mod/KVS1_pas.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "KVS1_pas.mod Potassium ion channel of HH model in C.elegans";
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
  ...
  _lq10 = pow( 3.0 , ( ( celsius - 6.3 ) / 10.0 ) ) ;
   ...
   mtau = m_a / ( 1.0 + exp ( ( _lv - m_b ) / m_c ) ) + m_d ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "KVS1_pas.mod";
static const char* nmodl_file_text = 
