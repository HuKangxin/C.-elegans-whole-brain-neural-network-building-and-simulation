...
#define nrn_init _nrn_init__ITR1_ca
#define _nrn_initial _nrn_initial__ITR1_ca
#define nrn_cur _nrn_cur__ITR1_ca
#define _nrn_current _nrn_current__ITR1_ca
#define nrn_jacob _nrn_jacob__ITR1_ca
#define nrn_state _nrn_state__ITR1_ca
#define _net_receive _net_receive__ITR1_ca 
#define rates rates__ITR1_ca 
#define states states__ITR1_ca 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_ITR1_ca", _hoc_setdata,
 "rates_ITR1_ca", _hoc_rates,
 0, 0
};
...
#define _gth 0
#define h_d h_d_ITR1_ca
 double h_d = 1.6;
#define h_c h_c_ITR1_ca
 double h_c = 9.4;
#define h_b h_b_ITR1_ca
 double h_b = -75.7;
#define h_a h_a_ITR1_ca
 double h_a = 22.4;
#define h_V h_V_ITR1_ca
 double h_V = -73;
#define htau_ITR1_ca _thread1data[0]
#define htau _thread[_gth]._pval[0]
#define hinf_ITR1_ca _thread1data[1]
#define hinf _thread[_gth]._pval[1]
#define k_i k_i_ITR1_ca
 double k_i = 8.1;
#define k_a k_a_ITR1_ca
 double k_a = 2.4;
#define m_d m_d_ITR1_ca
 double m_d = 0.4;
#define m_c m_c_ITR1_ca
 double m_c = 21.1;
#define m_b m_b_ITR1_ca
 double m_b = -92.5;
#define m_a m_a_ITR1_ca
 double m_a = 20;
#define m_V m_V_ITR1_ca
 double m_V = -50;
#define mtau_ITR1_ca _thread1data[2]
#define mtau _thread[_gth]._pval[2]
#define minf_ITR1_ca _thread1data[3]
#define minf _thread[_gth]._pval[3]
 ...
 "mtau_ITR1_ca", "ms",
 "htau_ITR1_ca", "ms",
 "gitr1bar_ITR1_ca", "nS/cm2",
 "gitr1_ITR1_ca", "nS/cm2",
 0,0
};
 ...
 "m_V_ITR1_ca", &m_V_ITR1_ca,
 "k_a_ITR1_ca", &k_a_ITR1_ca,
 "h_V_ITR1_ca", &h_V_ITR1_ca,
 "k_i_ITR1_ca", &k_i_ITR1_ca,
 "m_a_ITR1_ca", &m_a_ITR1_ca,
 "m_b_ITR1_ca", &m_b_ITR1_ca,
 "m_c_ITR1_ca", &m_c_ITR1_ca,
 "m_d_ITR1_ca", &m_d_ITR1_ca,
 "h_a_ITR1_ca", &h_a_ITR1_ca,
 "h_b_ITR1_ca", &h_b_ITR1_ca,
 "h_c_ITR1_ca", &h_c_ITR1_ca,
 "h_d_ITR1_ca", &h_d_ITR1_ca,
 "minf_ITR1_ca", &minf_ITR1_ca,
 "hinf_ITR1_ca", &hinf_ITR1_ca,
 "mtau_ITR1_ca", &mtau_ITR1_ca,
 "htau_ITR1_ca", &htau_ITR1_ca,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 ITR1_ca D:/download/yanjjiusheng/hukangxin/hukangxin/mod/ITR1_ca.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "ITR1_ca.mod";
static const char* nmodl_file_text = 
  ...
  "        RANGE  gitr1bar, gitr1                : gcca1bar is max gcca1\n"
  ...
  "\n"
  "PARAMETER {\n"
  "        gitr1bar  = 1 (nS/cm2)   : 0.7 for AWC_ON, 3.1 for RMD\n"
  "    : minf\n"
  "		m_V = -50 (mV)        : -57.7 as an exchange\n"
