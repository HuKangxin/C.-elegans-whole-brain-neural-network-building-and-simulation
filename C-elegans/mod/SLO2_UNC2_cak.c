...
#define nrn_init _nrn_init__SLO2_UNC2_cak
#define _nrn_initial _nrn_initial__SLO2_UNC2_cak
#define nrn_cur _nrn_cur__SLO2_UNC2_cak
#define _nrn_current _nrn_current__SLO2_UNC2_cak
#define nrn_jacob _nrn_jacob__SLO2_UNC2_cak
#define nrn_state _nrn_state__SLO2_UNC2_cak
#define _net_receive _net_receive__SLO2_UNC2_cak 
#define rates rates__SLO2_UNC2_cak 
#define states states__SLO2_UNC2_cak 
...
#define gslo2_unc2bar _p[0]
#define gslo2_unc2 _p[1]
#define m _p[2]
#define Dm _p[3]
#define ek _p[4]
#define ik _p[5]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_SLO2_UNC2_cak", _hoc_setdata,
 "rates_SLO2_UNC2_cak", _hoc_rates,
 0, 0
};
 /* declare global and static user variables */
#define mtau mtau_SLO2_UNC2_cak
 double mtau = 0;
#define minf minf_SLO2_UNC2_cak
 double minf = 0;
 ...
 "mtau_SLO2_UNC2_cak", "ms",
 "gslo2_unc2bar_SLO2_UNC2_cak", "pS/cm2",
 "gslo2_unc2_SLO2_UNC2_cak", "pS/cm2",
 "mtau_unc2_SLO2_UNC2_cak", "ms",
 0,0
};
 ...
 "minf_SLO2_UNC2_cak", &minf_SLO2_UNC2_cak,
 "mtau_SLO2_UNC2_cak", &mtau_SLO2_UNC2_cak,
 0,0
};
...
#define _cvode_ieq _ppvar[7]._i
 ...
 "7.7.0",
"SLO2_UNC2_cak",
 "gslo2_unc2bar_SLO2_UNC2_cak",
 0,
 "gslo2_unc2_SLO2_UNC2_cak",
 0,
 "m_SLO2_UNC2_cak",
 0,
 "minf_unc2_SLO2_UNC2_cak",
 "mtau_unc2_SLO2_UNC2_cak",
 "m_unc2_SLO2_UNC2_cak",
 "h_unc2_SLO2_UNC2_cak",
 0};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 7, "cvodeieq");
 	...
 	ivoc_help("help ?1 SLO2_UNC2_cak D:/download/yanjjiusheng/hukangxin/hukangxin/mod/SLO2_UNC2_cak.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "SLO2_UNC2_cak.mod Potassium ion channel of HH model in C.elegans";
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 50 in file SLO2_UNC2_cak.mod:\n        SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "SLO2_UNC2_cak.mod";
static const char* nmodl_file_text = 
