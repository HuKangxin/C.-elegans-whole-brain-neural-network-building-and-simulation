...
#define factor factor_ExpSynSTDP
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 add_nrn_fornetcons(_mechtype, _fnc_index);
 	...
 	ivoc_help("help ?1 ExpSynSTDP D:/download/yanjjiusheng/hukangxin/hukangxin/mod/expsynstdp.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "expsynstdp.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
